...
public class mainframe extends javax.swing.JFrame {
    ...
    private void opboxMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_opboxMouseClicked
       if(game_new==false){
           game_new=true;
           turn='X';
        wintt.setText("");
    ...
    }//GEN-LAST:event_opboxMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                AudioStream as=new AudioStream(inurl.openStream());
